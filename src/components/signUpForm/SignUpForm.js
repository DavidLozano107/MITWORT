...
import { faUser, faLock, faEnvelope, faBirthdayCake, faVenusMars } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="register-container">
          <form onSubmit={handledSubmit}>
            ...
            <div className="input-div five">
              <div className="i">
                <i className="fas fa-birthday-cake"><FontAwesomeIcon icon={faBirthdayCake}/></i>
              </div>
              <div>
                <Field
                 className="input"
            ...
            <div className="input-div six">
              <div className="i">
                <i className="fas fa-venus-mars"><FontAwesomeIcon icon={faVenusMars}/></i>
              </div>
              <div>
                <Field 
                className="input" 
...
export default withFormik({
  ...
  validate(values){
    ...
    }else if ( !/^[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$/.test(values.emailUser)) {
