          ...
          <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
              <div class="media align-items-end profile-head">
                ...
                <div class="media-body mb-5 text-white">
                  ...
                  <p class="small mb-4">
                    <i class="fas fa-map-marker-alt mr-2"></i>Ibague
                  </p>
                </div>
              </div>
            </div>
            <div class="bg-light p-4 d-flex justify-content-end text-center">
              <ul class="list-inline mb-0">
                <li class="list-inline-item">
                  <h5 class="font-weight-bold mb-0 d-block">7</h5>
                ...
                <li class="list-inline-item">
                  <h5 class="font-weight-bold mb-0 d-block">2020</h5>
                  <small class="text-muted">
            ...
            <div class="px-4 py-3">
              ...
              <div class="p-4 rounded shadow-sm bg-light">
                ...
                <p class="font-italic mb-0">Lives in Ibague</p>
                <p class="font-italic mb-0">Javascript 🔥</p>
              </div>
            </div>
            <div class="py-4 px-4">
